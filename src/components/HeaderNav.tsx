  ...
  return (
    <Flex pl={2} flexDirection={'column'}  justify={'flex-end'} py={'18px'} borderBottom={'1px'} borderBottomColor={'#E5EAEF;'}>
        <HStack display={'flex'} justifyContent={'space-between'} alignItems={'center'}>
            ...
            <Box ml={9} display={'flex'} justifyContent={'flex-end'} alignItems={'center'} gap={'20px'}>
                {calenderIcon}
            ...
            <Box display={'flex'} mr={'150px'} p={'3px 9px 0px '} justifyContent={'center'} alignItems={'center'} gap={'12px'} borderRadius={'28px'} border={'1px solid #DADDDD'}>
